...
const files={'/':'index.html','/index.html':'index.html','/app.js':'app.js','/core.js':'core.js','/style.css':'style.css','/feedback.js':'feedback.js','/cloud.js':'cloud.js','/firebase-config.js':'firebase-config.js'};
